...
import com.engagepoint.msap.MsapTestUtil;
import com.engagepoint.msap.Application;
import com.engagepoint.msap.MockMailSender;
...
import com.engagepoint.msap.service.UserService;
...
import static com.engagepoint.msap.MsapTestUtil.*;
...
public class UserResourceIntTest {
    ...
    public void testCreateAndUpdateUser() throws Exception {
        ...
        ResultActions resultActions = performCreateUser(restUserMockMvc, user)
            ...
            .andExpect(content().contentType(MediaType.APPLICATION_JSON))
            .andExpect(header().string("X-msapApp-alert", "user-management.created"))
            .andExpect(header().string("X-msapApp-params", user.getLogin()));
        ...
        performUpdateUser(restUserMockMvc, user)
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON))
            .andExpect(header().string("X-msapApp-alert", "user-management.updated"))
            .andExpect(header().string("X-msapApp-params", user.getLogin()));
    ...
    public void testCreateUserLoginAlreadyInUse() throws Exception {
        ...
        performCreateUser(restUserMockMvc, userJohn)
            ...
            .andExpect(header().string("X-msapApp-error", "error.userexists"))
            .andExpect(header().string("X-msapApp-params", "user-management"))
    ...
    public void testCreateUserEmailAlreadyInUse() throws Exception {
        ...
        performCreateUser(restUserMockMvc, userJohn)
            .andExpect(status().isBadRequest())
            .andExpect(header().string("X-msapApp-error", "error.emailexists"))
            .andExpect(header().string("X-msapApp-params", "user-management"))
            .andExpect(content().bytes(new byte[]{}));
    }
    ...
    public void testDeleteUser() throws Exception {
        User user = MsapTestUtil.newUserAnnaBrown(passwordEncoder, authorityRepository);
