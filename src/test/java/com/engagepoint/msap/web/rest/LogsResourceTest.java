...
import com.engagepoint.msap.web.rest.dto.LoggerDTO;
...
public class LogsResourceTest {
    ...
    public void testGetList() throws Exception {
        restResourceMockMvc.perform(
            ...
            .andExpect(jsonPath("$.[*].name").value(hasItem("com.engagepoint.msap.Application")))
            .andExpect(jsonPath("$.[*].name").value(hasItem("com.engagepoint.msap.config.WebsocketConfiguration")))
            .andExpect(jsonPath("$.[*].name").value(hasItem("com.engagepoint.msap.service.MailService")))
            .andExpect(jsonPath("$.[*].name").value(hasItem("com.engagepoint.msap.service.UserService")))
