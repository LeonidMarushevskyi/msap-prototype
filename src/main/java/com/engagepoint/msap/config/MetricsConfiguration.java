...
import com.engagepoint.msap.config.zabbix.ActiveChecksRequest;
import com.engagepoint.msap.config.zabbix.MsapZabbixResponse;
import com.engagepoint.msap.config.zabbix.MsapZabbixSender;
import com.engagepoint.msap.config.zabbix.ZabbixResponseType;
...
public class MetricsConfiguration extends MetricsConfigurerAdapter {
    ...
    private static final String APPLICATION_INSTANCE_PREFIX = "msap";
    ...
    public static class ZabbixRegistry {
        ...
        private void confugureApplicationInstanceZabbixHost(JHipsterProperties.Metrics.Zabbix zabbixProperties) throws IOException {
            ...
            MsapZabbixSender msapZabbixSender =
                new MsapZabbixSender(zabbixHost, zabbixPort, connectionTimeout, socketTimeout);
            ...
            MsapZabbixResponse zabbixRespone = msapZabbixSender.send(activeChecksRequest);
            ...
            if(zabbixRespone.getType() == ZabbixResponseType.SUCCESS){
                ...
                MsapZabbixResponse zabbixRespone2 = msapZabbixSender.send(activeChecksRequest);
