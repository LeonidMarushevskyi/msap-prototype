...
import com.engagepoint.msap.security.*;
import com.engagepoint.msap.web.filter.CredentialLoggingFilter;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        .and()
            ...
            .antMatchers("/api/lookupProviderTypes").permitAll()
            ...
            .addFilterAfter(new CredentialLoggingFilter(), SessionManagementFilter.class)
            ///TODO: CSRF Temporary disabled
            .csrf().disable() ;
