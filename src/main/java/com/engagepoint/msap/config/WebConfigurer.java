...
import com.engagepoint.msap.web.filter.CachingHttpHeadersFilter;
import com.engagepoint.msap.web.filter.StaticResourcesProductionFilter;
...
public class WebConfigurer implements ServletContextInitializer, EmbeddedServletContainerCustomizer {
    ...
    private void initClusteredHttpSessionFilter(ServletContext servletContext, EnumSet<DispatcherType> disps) {
        LOGGER.debug("Registering Clustered Http Session Filter");
        ...
        parameters.put("instance-name", "msap");
