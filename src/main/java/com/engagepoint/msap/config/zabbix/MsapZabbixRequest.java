...
import static com.engagepoint.msap.config.zabbix.ZabbixConstants.HEADERS_LENGTH;
import static com.engagepoint.msap.config.zabbix.ZabbixConstants.ZABBIX_HEADER;

/**
 * Created by dmytro.palczewski on 6/6/2016.
 */
public abstract class MsapZabbixRequest {

    private String request;

    public MsapZabbixRequest(String request){
