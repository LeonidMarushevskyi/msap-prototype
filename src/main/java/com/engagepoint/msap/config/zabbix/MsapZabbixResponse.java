 ...
 */
public class MsapZabbixResponse {

    public static final MsapZabbixResponse EMPTY_RESPONSE = new MsapZabbixResponse(ZabbixResponseType.EMPTY);
    ...
    public MsapZabbixResponse(ZabbixResponseType type){
        this.type = type;
    }

    public MsapZabbixResponse(String stringValue){
