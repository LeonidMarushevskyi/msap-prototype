...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        sprite:{
            all: {
                src: ['src/main/webapp/assets/images/main-nav/*.png'],
                dest: 'src/main/webapp/assets/images/global.png',
                destCss: 'src/main/scss/_sprites.scss',
                imgPath: '../images/global.png',
                padding: 10
            }
        },
        wiredep: {
            ...
            dist: {
                files: {
                    src: [
                        ...
                        '<%= yeoman.dist %>/assets/images/**/*.{png,jpg,gif,webp,svg}',
